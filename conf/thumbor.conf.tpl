...
############################### thumbor-plugins ################################
JP2_QUALITY = {{ JP2_QUALITY | default(None) }}
MOZJPEG_QUALITY = {{ MOZJPEG_QUALITY | default(None) }}
OPTIPNG_LEVEL = {{ OPTIPNG_LEVEL | default(1) }}
PNGQUANT_QUALITY = {{ PNGQUANT_QUALITY | default(None) }}
PNGQUANT_SPEED = {{ PNGQUANT_SPEED | default(None) }}
################################################################################
